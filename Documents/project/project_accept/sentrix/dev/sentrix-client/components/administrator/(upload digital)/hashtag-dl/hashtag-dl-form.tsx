...
import { HashtagDLFormProps } from '@/types/components';

import { filterSupportedFiles, getSupportedFileTypesMessage } from '@/utils/upload-file-validator';

const HashtagDLForm = ({ onSubmit }: HashtagDLFormProps) => {
  ...
  const { mutate, isPending } = useMutation({
    ...
    onSuccess: ({ success, message }) => {
      ...
      router.push(`/dashboard/administrator/upload-digital/hashtag-dl`);
      showMessage(message);
    },
    onError: (error: Error) => {
