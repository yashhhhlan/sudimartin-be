...
import { WebVisitsFormProps } from '@/types/components';

import { filterSupportedFiles, getSupportedFileTypesMessage } from '@/utils/upload-file-validator';

const WebVisitsForm = ({ onSubmit }: WebVisitsFormProps) => {
  ...
  const { mutate, isPending } = useMutation({
    ...
    onSuccess: ({ success, message }) => {
      ...
      router.push(`/dashboard/administrator/upload-digital/web-visits`);
      showMessage(message);
    },
    onError: (error: Error) => {
